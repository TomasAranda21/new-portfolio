    ...
    <section className=" bg-verdeClaro ">
      ...
      <div className="flex flex-col items-center gap-10">
        <div className="flex gap-3 items-center">
          <ButtonSkills text="Experiencia"/>
          <ButtonSkills text="Educacion"/>
        </div>
