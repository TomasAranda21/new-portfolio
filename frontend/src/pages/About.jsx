...
const About = () => {
  return (
    ...
    <section className="">
      ...
      <div className="relative pt-40 w-5/6 mx-auto">
        <div className="flex justify-center gap-20 relative z-10 items-center">


          <div className="w-1/3 flex flex-col gap-5 font-medium ">
          ...
          <div className='overflow-hidden  rounded-full relative bg-gray-50 '>
