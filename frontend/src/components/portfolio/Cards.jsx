    ...
    <div className="cards ">
        ...
        <div className="info_container">
            ...
            <div className="flex gap-4 items-center justify-center text-gray-300">
              <a className="text-gray-200 duration-300 hover:text-gray-400" href={linkGit} target="_blank" > <FontAwesomeIcon icon={faGithub} className=""/> </a>
              <a className="text-naraja hover:text-amber-600 duration-300" href={linkWeb} target="_blank" > <FontAwesomeIcon icon={faArrowUpRightFromSquare}/> Link web</a>
            </div>
        </div>
